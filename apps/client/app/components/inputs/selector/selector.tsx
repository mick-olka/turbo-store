...
export const Selector = <T extends string | number>({ list, value, onItemSelect, className, ...props }: Props<T>) => {
  ...
  return (
    <Dropdown itemsList={itemsList} {...props} className={classnames(className)}>
